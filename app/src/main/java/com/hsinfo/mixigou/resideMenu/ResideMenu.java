package com.hsinfo.mixigou.resideMenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private TextView user_jobnumber;
    private TextView tv_depict;
    
    public void setPhoto(Bitmap icon)
    {
    	user_photo.setImageBitmap(icon);
    }
    ...
    public void setJobNumber(String text){
    	user_jobnumber.setText(text);
    }
    
    
    public ResideMenu(Context context, Bitmap photo, String name, String jobnumber) {
        super(context);
        initViews(context);
        if(photo!=null){
        	setPhoto(photo);
    ...
    private void initViews(Context context)
    {
        ...
        scrollViewLeftMenu = (ScrollView) findViewById(R.id.sv_left_menus);
        ...
        imageViewBackground = (ImageView) findViewById(R.id.iv_backgrounds);
        
        user_photo = (ImageView) findViewById(R.id.user_photo);
        user_name = (TextView) findViewById(R.id.user_name);
        tv_depict = (TextView) findViewById(R.id.user_depict);
        
        String strdep = "";
        String versionapp;
        
        //versionapp = SmApplication.sharedProxy.getString("curVersion", "1.0");
        versionapp = "1.0";
        strdep = "您现在正在使用两河口水电站APP";
        tv_depict.setText(strdep);
        
        TextPaint tp = user_name.getPaint();
        tp.setFakeBoldText(true);
        user_jobnumber = (TextView) findViewById(R.id.user_jobnumber);
    }
     ...
     * Show the menu;
     */
    public void openMenu(int direction,int debug)
    {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isOpened())
                {
                    if (currentActivityScaleX > 0.56f)
                        ...
                        openMenu(scaleDirection,1);
                }
                else
                {
                    if (currentActivityScaleX < 0.94f)
                    {
                        openMenu(scaleDirection,2);
                    }
                    else
                    {
                        closeMenu();
